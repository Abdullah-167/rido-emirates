...
const ContactForm = () => {
  interface FormData {
    ...
    email: string;
    message: string;
    rideFrom: string; // Changed from `location`
    rideTo: string;   // Added `rideTo`
    time: string;
  }
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    email: "",
    message: "",
    rideFrom: "", // Changed from `location`
    rideTo: "",   // Added `rideTo`
    time: "",
  });
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (!formData.rideFrom) formErrors.rideFrom = "Ride From is required"; // Changed from `location`
    if (!formData.rideTo) formErrors.rideTo = "Ride To is required";       // Added `rideTo`
      ...
      <div className="relative flex min-h-screen mb-20">
        ...
        <div className="w-full max-w-[600px] bg-[#07aae7] text-white p-6 hidden md:flex flex-col justify-center">
          ...
          <p className="text-lg mb-4">
            We are always here to assist you with anything you need. Just drop
            us a message, and we’ll take care of the rest. Your comfort is our
            top priority, and we ensure a smooth and safe ride.
          </p>
          <p className="text-lg">
            Let us take care of your journey — from you, to your destination,
          ...
          {!submitted ? (
            ...
            >
              ...
              <div className="mb-4">
                ...
                <input
                  type="text"
                  name="rideFrom" // Changed from `location`
